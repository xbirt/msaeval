...
set -e
sudo apt update
apt install -y --no-install-recommends time screen
#sudo apt install -y --no-install-recommends t-coffee
...
rm -rf T-COFFEE_installer_Version_13.46.0.919e8c6b_linux_x64.bin
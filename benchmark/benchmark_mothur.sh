...
./benchmark.sh "mothur/mothur" "\"#align.seqs(fasta=0.1k.fasta, reference=silva.nr_v138_2.align, processors=$THREADS)\""
gzip 0.1k.align
./benchmark.sh "mothur/mothur" "\"#align.seqs(fasta=0.5k.fasta, reference=silva.nr_v138_2.align, processors=$THREADS)\""
gzip 0.5k.align
